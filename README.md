...
- **Open Shifts** — add shifts you're considering picking up (from a marketplace, group chat, etc.) and each one is checked against your committed schedule:
  ...
  - **Conflict (red)** — it overlaps a shift you already have. You can still force-add it, but you'll be warned.
...
- **Dashboard** shows your recent activity: hours and earnings for shifts actually *worked* this week/this month, plus your upcoming and recent shifts.
